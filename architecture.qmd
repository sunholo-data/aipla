...
- **v1 scope:** **per-class enforcement only in v1.** Per-group counters and skill multipliers are Year-2 refinements; v1's simpler model (one cap per class) is enough to ship a safe pilot in August.
