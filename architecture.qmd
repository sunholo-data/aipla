...
- Renderer (frontend) must support the four surfaces and route components from A2UI's `surfaceId` to the right region. The AI Protocol Platform template's reference frontend may need extension here — to verify during the build phase.
