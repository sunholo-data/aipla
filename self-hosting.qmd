...
For every cloud component used in the prototype, this page captures the UCPH-self-host equivalent and what would be needed to migrate. Half of the final handover package.

**Status:** stub. To be populated as architecture decisions on the [Architecture](architecture.qmd) page solidify.
