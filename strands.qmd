...
gantt
    ...
    M + JB holiday            :crit, 2026-07-01, 14d
    Final handover            :milestone, m2, 2026-09-15, 0d
```

Strand A's core build runs through to the **mid-point review on 26 June**, before M and JB both go on holiday. Strands B and C kick off on return (mid-July). Teacher pilot starts when Danish teachers return mid-August.
