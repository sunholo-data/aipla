...
- **Researcher role** — separate permission tier above teacher: cross-class, cross-teacher access to all sessions and raw BigQuery. Not modelled in the current teacher permission sprint; needs an ADR addition.
