...
| Skill | What it does | Artefact / surface |
|---|---|---|
...
| `problem-set-helper` (teacher config) | Configures a student-facing tutor for a given problem set with hint structure | Skill template |
| `concept-dialogue` (teacher config) | Configures a Socratic conceptual-exploration tutor for a topic | Skill template |
| `lab-troubleshoot` (teacher config) | Configures a tutor that helps students debug experimental data (CSV / Tracker / photos) | Skill template + AILANG Parse for uploads |
