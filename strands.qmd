...
All teacher tasks happen in the **same chat UI** as students — different skills, different rich UI components emitted, no separate teacher app (see [ADR-015](architecture.qmd#adr-015-unified-chat-ui-no-separate-teacher-dashboard)).
