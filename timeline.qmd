...
| 1. Build (Strand A core) | 3–6 | May 27 – Jun 26 | **In progress — ahead of plan.** By week 3: teacher UI wired to backend, teacher permission model, lesson picker, LED Planck (skill 2), KineBot (skill 3), proactive tutor greet, commit-on-submit, chat log pipeline (BigQuery). 3 June check-in confirmed direction; key v1.1 additions: teacher activity creation + branching, student image upload, proactive sim-reactive tutor, student consent prompt, researcher role. Next: session persistence, teacher UI Phase 3 (Firebase auth). |
