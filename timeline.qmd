...
**Mid-point review:** week 6 (~2026-06-26), before both M and JB go on holiday
**Holiday window:** ~early-to-mid July — JB on Danish summer break; M at Croatia workshop
...
gantt
    ...
    Internal iteration        :a3, 2026-07-15, 30d
    Teacher pilot             :a4, 2026-08-14, 32d
    ...
    section Strand C
    Scoping kickoff           :c1, 2026-07-15, 21d
...
|---|---|---|---|
| 1. Decide & set up | 1–2 | May 15 – May 29 | ADRs done; GCP projects (`aipla-dev/test/prod-2026`) live; template bootstrapped |
| 2. Build (Strand A core) | 3–6 | May 29 – Jun 26 | Vertical slice → RAG → multimodal → teacher bot config |
| **Mid-point review** | 6 | ~Jun 26 | Live demo + scope review **before holidays** |
| Both on holiday (M + JB) | 7–8 | ~Jul 1 – Jul 15 | Code freeze. JB on Danish summer break; M at Croatia workshop |
| 3. Internal iteration | 9–12 | Jul 15 – Aug 14 | First eval run; iterate Strand A; Strand B build; Strand C scoping kickoff |
| 4. Teacher pilot | 13–14 | Aug 14 – Aug 28 | Real teachers (10 Danish + K) engage; capability-floor eval refresh |
| 5. Strand C scoping draft | 14–16 | Aug 19 – Sep 9 | 5–10pp scoping note: beyond-LLMs, beyond-chat, student models |
| 6. Handover-intensive | 16–17 | Sep 2 – Sep 15 | Final docs, deep-dive sessions, sign-offs |
