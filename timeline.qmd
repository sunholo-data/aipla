...
| **0.5. Jutland demo (v0.1)** | 2 | May 22 – May 27 | Upstream group-ID auth landed 2026-05-19 (+ tenant-span hook + artefact-review pipeline). Forked into `sunholo-data/cphu-aipla-app` (private) on 2026-05-19. Configure for AIPLA; minimum chat URL + one physics-tutor skill + group-ID join. **JB + Aswin to Jutland 27–29 May.** |
| 1. Build (Strand A core) | 3–6 | May 27 – Jun 26 | Layer on RAG → multimodal → teacher bot configuration UI |
