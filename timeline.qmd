...
|---|---|---|---|
| 0. Decide & set up | 1 | May 15 – May 22 | ADRs done; GCP projects (`aipla-dev/test/prod-2026`) live |
| **0.5. Jutland demo (v0.1)** | 2 | May 22 – May 27 | Bootstrap template; minimum chat URL with one physics-tutor skill; group-ID join. **JB + Aswin to Jutland 27–29 May.** |
