...
| **0.5. Jutland demo (v0.1)** | 2 | May 22 – May 27 | **Group-ID auth lands upstream by Tue 26 May.** Fork the updated platform into `sunholo-data/cphu-aipla-app`; configure for AIPLA; minimum chat URL + one physics-tutor skill + group-ID join. **JB + Aswin to Jutland 27–29 May.** |
